...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/esast-util-from-estree
   cd esast-util-from-estree
   ```
...
```sh
https://github.com/flex-development/esast-util-from-estree/compare/main...$branch
```
...
[discussion-qa]: https://github.com/flex-development/esast-util-from-estree/discussions/new?category=q-a
